...
public class CompatibleImageDecoder implements ImageDecoder {
      ...
      */
     public CompatibleImageDecoder(boolean loggingEnabled) {
     ...
     protected ImageFileInfo defineImageSizeAndRotation(InputStream imageStream, ImageDecodingInfo decodingInfo)
             ...
             Log.v("trace", "FUCK " + decodingInfo.shouldConsiderExifParams());
	...
	protected ExifInfo defineExifOrientation(String imageUri) {
		if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ECLAIR){
			return CompatibleImageDecoderReflection.defineExifOrientation(imageUri);
		} else {
